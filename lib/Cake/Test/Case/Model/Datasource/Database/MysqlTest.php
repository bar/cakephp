...
#					'type' => 'enum',
##					'values' => array(',', '', ',\'\',', 'laso\'s'),
#					'values' => array('Simple', 'He said \'no way!\'', 'Really?', '', '\'\'', '\','),
#					'null' => true
#				),
#			)
#		));
...
/**
 * Test that a MySQL column description has the shape of an enumerated column type.
 *
...
/**
 * Test that a MySQL column description has the shape of an invalid enumerated column type.
 *
...
#		$expected = array('unique');
#		$result = $this->Dbo->enumerationValues('set(\'unique\')');
#		$this->assertEquals($expected, $result);
#		$result = $this->Dbo->enumerationValues('set (\'unique\')');
#		$this->assertEquals($expected, $result);
#		$result = $this->Dbo->enumerationValues(' set ( \'unique\' ) ');
...
#		$this->assertEquals($expected, $result);
#		$result = $this->Dbo->enumerationValues('setno(\'one\',\'two\')');
#		$this->assertEquals($expected, $result);
...
#/**
# * Test getting comma-separated values from an enumerated column type.
# *
# * @return void
# */
#	public function testEnumerationValuesCommaSeparated() {
#		$expected = array('notseparated', 'comma,separated, value');
#		$result = $this->Dbo->enumerationValues('enum(\'notseparated\',\'comma,separated, value\')');
#		$this->assertEquals($expected, $result);
#		$result = $this->Dbo->enumerationValues('enum (\'notseparated\', \'comma,separated, value\')');
#		$this->assertEquals($expected, $result);
#		$result = $this->Dbo->enumerationValues(' enum ( \'notseparated\' , \'comma,separated, value\' ) ');
...
#		$expected = array(',', ' ,', ',,,', ' ,');
#		$result = $this->Dbo->enumerationValues('enum(\',\',\' ,\',\',,,\',\' ,\')');
#		$this->assertEquals($expected, $result);
#		$result = $this->Dbo->enumerationValues('enum (\',\', \' ,\', \',,,\', \' ,\')');
#		$this->assertEquals($expected, $result);
#		$result = $this->Dbo->enumerationValues(' enum ( \',\' , \' ,\' , \',,,\' , \' ,\' ) ');
...
#/**
# * Test getting values with apostrophes from an enumerated column type.
# *
# * @return void
# */
#	public function testEnumerationValuesApostrophe() {
#		$expected = array('Burguer King', 'McDonalds\'s');
#		$result = $this->Dbo->enumerationValues('enum(\'Burguer King\',\'McDonalds\'s\')');
#		$this->assertEquals($expected, $result);
#		$result = $this->Dbo->enumerationValues('enum (\'Burguer King\', \'McDonalds\'s\')');
#		$this->assertEquals($expected, $result);
#		$result = $this->Dbo->enumerationValues(' enum ( \'Burguer King\' , \'McDonalds\'s\' ) ');
...
#		$expected = array('McDonalds\'s');
#		$result = $this->Dbo->enumerationValues('enum(\'McDonalds\'s\')');
#		$this->assertEquals($expected, $result);
#		$result = $this->Dbo->enumerationValues(' enum ( \'McDonalds\'s\' ) ');
#		$this->assertEquals($expected, $result);
#	}
...
#/**
# * Test getting empty values from an enumerated column type.
# *
# * @return void
# */
#	public function testEnumerationValuesEmpty() {
#		$expected = array('dog', 'cat', '', 'wabbit');
#		$result = $this->Dbo->enumerationValues('enum(\'dog\',\'cat\',\'\',\'wabbit\')');
#		$this->assertEquals($expected, $result);
#		$result = $this->Dbo->enumerationValues('enum (\'dog\', \'cat\', \'\', \'wabbit\')');
#		$this->assertEquals($expected, $result);
#		$result = $this->Dbo->enumerationValues(' enum ( \'dog\', \'cat\', \'\' ,\'wabbit\' ) ');
...
#/**
# * Test getting complex values from an enumerated column type.
# *
# * It's not magic, when comma/apostrophe abusing it may fail miserably.
# *
# * @return void
# */
#	public function testEnumerationValuesComplex() {
#		$expected = array('Simple', 'He said \'no way!\'', 'Bär?', '', '\'\'', '\',');
#		$result = $this->Dbo->enumerationValues('enum(\'Simple\',\'He said \'no way!\'\',\'Bär?\',\'\',\'\'\'\',\'\',\')');
#		$this->assertEquals($expected, $result);
#		$result = $this->Dbo->enumerationValues('enum (\'Simple\', \'He said \'no way!\'\', \'Bär?\', \'\', \'\'\'\', \'\',\')');
#		$this->assertEquals($expected, $result);
#		$result = $this->Dbo->enumerationValues(' enum ( \'Simple\', \'He said \'no way!\'\' , \'Bär?\' , \'\' , \'\'\'\' , \'\',\')');
